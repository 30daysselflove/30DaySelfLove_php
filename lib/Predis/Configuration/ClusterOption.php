...
use lib\Predis\Connection\Aggregate\ClusterInterface;
use lib\Predis\Connection\Aggregate\PredisCluster;
use lib\Predis\Connection\Aggregate\RedisCluster;
    ...
    public function filter(OptionsInterface $options, $value)
    {
        ...
        if (!$value instanceof ClusterInterface) {
            throw new InvalidArgumentException(
                "An instance of type 'lib\Predis\Connection\Aggregate\ClusterInterface' was expected."
            );
        }
