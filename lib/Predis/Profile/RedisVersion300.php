...
class RedisVersion300 extends RedisProfile
{
    ...
    public function getSupportedCommands()
    {
        return array(
            ...
            /* commands operating on the key space */
            'SCAN'                      => 'lib\Predis\Command\KeyScan',

            /* commands operating on sets */
            'SSCAN'                     => 'lib\Predis\Command\SetScan',

            /* commands operating on sorted sets */
            'ZSCAN'                     => 'lib\Predis\Command\ZSetScan',
            'ZLEXCOUNT'                 => 'lib\Predis\Command\ZSetLexCount',
            'ZRANGEBYLEX'               => 'lib\Predis\Command\ZSetRangeByLex',
            'ZREMRANGEBYLEX'            => 'lib\Predis\Command\ZSetRemoveRangeByLex',

            /* commands operating on hashes */
            'HSCAN'                     => 'lib\Predis\Command\HashScan',

            /* publish - subscribe */
            'PUBSUB'                    => 'lib\Predis\Command\PubSubPubsub',

            /* commands operating on HyperLogLog */
            'PFADD'                     => 'lib\Predis\Command\HyperLogLogAdd',
            'PFCOUNT'                   => 'lib\Predis\Command\HyperLogLogCount',
            'PFMERGE'                   => 'lib\Predis\Command\HyperLogLogMerge',

            /* remote server control commands */
            'COMMAND'                   => 'lib\Predis\Command\ServerCommand',
