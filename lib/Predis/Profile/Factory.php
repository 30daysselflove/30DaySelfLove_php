...
use ReflectionClass;
use lib\Predis\ClientException;
...
final class Factory
{
    private static $profiles = array(
        '2.0'     => 'lib\Predis\Profile\RedisVersion200',
        '2.2'     => 'lib\Predis\Profile\RedisVersion220',
        '2.4'     => 'lib\Predis\Profile\RedisVersion240',
        '2.6'     => 'lib\Predis\Profile\RedisVersion260',
        '2.8'     => 'lib\Predis\Profile\RedisVersion280',
        '3.0'     => 'lib\Predis\Profile\RedisVersion300',
        'default' => 'lib\Predis\Profile\RedisVersion300',
        'dev'     => 'lib\Predis\Profile\RedisUnstable',
    );
    ...
    public static function define($alias, $class)
    {
        ...
        if (!$reflection->isSubclassOf('lib\Predis\Profile\ProfileInterface')) {
