...
namespace lib\Predis\Connection;
...
class Factory implements FactoryInterface
{
    protected $schemes = array(
        'tcp'  => 'lib\Predis\Connection\StreamConnection',
        'unix' => 'lib\Predis\Connection\StreamConnection',
        'http' => 'lib\Predis\Connection\WebdisConnection',
    );
    ...
    protected function checkInitializer($initializer)
    {
        ...
        if (!$class->isSubclassOf('lib\Predis\Connection\NodeConnectionInterface')) {
    ...
    public function create($parameters)
    {
        ...
        if (!$connection instanceof NodeConnectionInterface) {
            throw new UnexpectedValueException(
                ...
                "'lib\Predis\Connection\NodeConnectionInterface'."
            );
        }
