...
use lib\Predis\Command\RawCommand;
use lib\Predis\Command\ScriptCommand;
use lib\Predis\Configuration\Options;
use lib\Predis\Configuration\OptionsInterface;
use lib\Predis\Connection\ConnectionInterface;
use lib\Predis\Connection\AggregateConnectionInterface;
use lib\Predis\Connection\ParametersInterface;
use lib\Predis\Monitor\Consumer as MonitorConsumer;
use lib\Predis\Pipeline\Pipeline;
use lib\Predis\PubSub\Consumer as PubSubConsumer;
use lib\Predis\Response\ErrorInterface as ErrorResponseInterface;
use lib\Predis\Response\ResponseInterface;
use lib\Predis\Response\ServerException;
use lib\Predis\Transaction\MultiExec as MultiExecTransaction;
...
class Client implements ClientInterface
{
    ...
    protected function createPipeline(array $options = null, $callable = null)
    {
        if (isset($options['atomic']) && $options['atomic']) {
            $class = 'lib\Predis\Pipeline\Atomic';
        } elseif (isset($options['fire-and-forget']) && $options['fire-and-forget']) {
            $class = 'lib\Predis\Pipeline\FireAndForget';
        } else {
            $class = 'lib\Predis\Pipeline\Pipeline';
        }
