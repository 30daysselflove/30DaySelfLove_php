<?php /* Smarty version Smarty-3.1.11, created on 2015-08-08 12:45:01
         compiled from "../application/view/join/reset-invalid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51128852855c65c3d0c7c56-68235045%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3298faf5a7d03ff33a0904c6ef612b1cc2a57ff' => 
    array (
      0 => '../application/view/join/reset-invalid.tpl',
      1 => 1430866767,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '51128852855c65c3d0c7c56-68235045',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_55c65c3d121ff2_48182155',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c65c3d121ff2_48182155')) {function content_55c65c3d121ff2_48182155($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
            ...
            $(function(){
                ...
                $("#pwform").submit(function(e)
                {
                    ...
                    if($("#pwform").valid())
                    {
                        ...
                        {
                            $("#pwform .form-validation").html("Password has been successfully changed!");
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    <form id="pwform" class="contact-form wow fadeInUp" data-wow-duration="1s" role="form">
                                        <h3>Invalid or Expired Reset Token. Please make another password reset request through the app</h3>
                                    </form>
                                </div>
                            </div>
